...
def developement():
        ...
        frostlib.scripts.molten_core.boss_lucifron().RegisterScript()
        frostlib.scripts.molten_core.boss_magmadar().RegisterScript()
        frostlib.scripts.molten_core.boss_gehennas().RegisterScript()
        frostlib.scripts.molten_core.boss_golemagg().RegisterScript()
        frostlib.scripts.molten_core.boss_shazzrah().RegisterScript()
        frostlib.scripts.molten_core.boss_sulfuron_harbringer().RegisterScript()
        frostlib.scripts.molten_core.mob_sulfuron_harbringer().RegisterScript()
        frostlib.scripts.molten_core.boss_majordomo_executus().RegisterScript()
        frostlib.scripts.zulgurub.boss_hakkar().RegisterScript()
        frostlib.scripts.zulgurub.boss_arlokk().RegisterScript()
        frostlib.scripts.zulgurub.boss_gahzranka().RegisterScript()
        frostlib.scripts.zulgurub.boss_grilek().RegisterScript()
        frostlib.scripts.zulgurub.boss_hazzarah().RegisterScript()
        frostlib.scripts.zulgurub.boss_jeklik().RegisterScript()
