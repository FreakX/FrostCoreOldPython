...
"SPELL_ATTR_UNK22"                          : 0x00400000,            # 22
...
"SPELL_ATTR_EX_NO_INITIAL_AGGRO"            : 0x00000400,            # 10 no generates threat on cast 100%
...
"SPELL_ATTR_EX3_UNK17"                      : 0x00020000,            # 17 no triggers effects that trigger on casting a spell??
"SPELL_ATTR_EX3_UNK18"                      : 0x00040000,            # 18
...
"SPELL_ATTR_EX6_NO_DMG_PERCENT_MODS"        : 0x20000000,            # 29 do not apply damage percent mods (usually in cases where it has already been applied)
...
SpellImmunity = {
    "IMMUNITY_EFFECT"                : 0,                     # SpellEffects
    "IMMUNITY_STATE"                 : 1,                     # AuraType
    "IMMUNITY_SCHOOL"                : 2,                     # SpellSchoolMask
    "IMMUNITY_DAMAGE"                : 3,                     # SpellSchoolMask
    "IMMUNITY_DISPEL"                : 4,                     # DispelType
    "IMMUNITY_MECHANIC"              : 5                      # Mechanics
}
...
TrainerType = {                                            # this is important type for npcs!
