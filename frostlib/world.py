...
class world(object):
    ...
    def loaditems(self):
        ...
        for entry in xrange(0,resultcount):
            ...
            item_spelltrigger_2 = int(currentry[70])
            item_spellcharges_2 = int(currentry[71])
            item_spellcooldown_2= int(currentry[72])
            item_spellcategory_2= int(currentry[73])
            item_spellcategorycooldown_2 = int(currentry[74])
            item_spelltrigger_3 = int(currentry[75])
            item_spellcharges_3 = int(currentry[76])
            item_spellcooldown_3 = int(currentry[77])
            item_spellcategory_3 = int(currentry[78])
            item_spellcategorycooldown = int(currentry[79])
            item_spelltrigger_4 = int(currentry[80])
            item_spellcharges_4 = int(currentry[81])
            item_spellcooldown_4 = int(currentry[82])
            item_spellcategory_4 = int(currentry[83])
            item_spellcategorycooldown_4 = int(currentry[84])
            item_spelltrigger_5 = int(currentry[85])
            item_spellcharges_5 = int(currentry[86])
            item_spellcooldown_5 = int(currentry[87])
            item_spellcategory_5 = int(currentry[88])
            item_spellcategorycooldown_5 = int(currentry[89])
            item_bonding = int(currentry[90])
            item_description = str(currentry[91])
            item_page_id = int(currentry[92])
            item_page_language = int(currentry[93])
            item_page_material = int(currentry[94])
            item_quest_id = int(currentry[95])
            item_lock_id = int(currentry[96])
            item_lock_material = int(currentry[97])
            item_sheathID = int(currentry[98])
            item_randomprop = int(currentry[99])
            item_randomsuffix = int(currentry[100])
            item_block = int(currentry[101])
            item_itemset = int(currentry[102])
            item_bagfamily = int(currentry[103])
            item_TotemCategory = int(currentry[104])
            item_socket_color_1 = int(currentry[105])
            item_unk201_3 = int(currentry[106])
            item_socket_color_2 = int(currentry[107])
            item_unk201_5 = int(currentry[108])
            item_socket_color_3 = int(currentry[109])
            item_unk201_7 = int(currentry[110])
            item_socket_bonus = int(currentry[111])
            item_GemProperties = int(currentry[112])
            item_ReqDisenchantSkill = int(currentry[113])
            item_ArmorDamageModifier = int(currentry[114])
            item_ExistingDuration = int(currentry[115])
            item_ItemLimitCategoryId = int(currentry[116])
            item_HolidayId = currentry[117]
            """
            item = frostlib.classes.item(
                item_entry,
                item_class,
                item_subclass,
                item_field4) # TODO: Pierre: Hier da alle Wete rein^^
            """
            item = frostlib.classes.item()
